...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Clínica BIENSANITOS</title>
    ...
    <body>
        ...
        <div id="contenedor">
            <div id="titulo">Clínica BIENSANITOS </div>
             <div id="menu"><?php include('menu.php');?></div>
            <div id="contenido">“Clínica BIENSANITOS”</div>
            <footer>Antonio Varas #666, Fono de Contacto: 00000000</footer>
        </div>
