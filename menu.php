...
<a id="subsolicitud" class="list-group-item submenu" href="<?=URLBASE;?>contenido/Reservation.php" ><i class="fas fa-hotel fa-2x"></i></i> Reservation</a>
<a id="subsolicitud" class="list-group-item submenu" href="<?=URLBASE;?>contenido/AboutChile.php" ><i class="fas fa-hotel fa-2x"></i></i> Reservation</a>
